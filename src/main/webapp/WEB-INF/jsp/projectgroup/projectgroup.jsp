...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend style="text-align: center">项目组列表界面</legend>
</fieldset>
<div style="padding: 20px; background-color: #F2F2F2;">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">项目组信息</div>
...
<script>
    layui.use(['table', 'form'], function () {
        ...
        table.render({
            elem: '#demo'
            , height: 312
            , url: '<%=contextPath%>/projectgroup/list' //数据接口
            , page: true //开启分页
            , cols: [[ //表头
                {type: 'checkbox', fixed: 'left'}
                , {field: 'id', title: '项目组ID', width: 200}
                , {field: 'groupName', title: '项目组名', width: 200}
        ...
        form.on('submit(queryForm)', function (data) {
            ...
            table.render({
                elem: '#demo'
                , height: 312
                , url: '<%=contextPath%>/projectgroup/search?portion=' + data.field.deptname//数据接口
                , page: true //开启分页
                , cols: [[ //表头
                    {type: 'checkbox', fixed: 'left'}
                    , {field: 'id', title: '项目组ID', width: 200}
